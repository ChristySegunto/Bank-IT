...
withdraw.iconbitmap(r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\logo.ico')

# window background
withdraw_background = ImageTk.PhotoImage(file=r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\backgroundtwo.png')
...
# window textbox
bluetextbox = Image.open(r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\bluetextbox.png')
...
def button1(event):
    print("1000")
button1_image = Image.open(r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\onethousand.png')
...
def button3(event):
    print("5000")
button3_image = Image.open(r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\fivethousand.png')
...
def button4(event):
    print("10000")
button4_image = Image.open(r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\tenthousand.png')
...
def button5(event):
    print("submit")
submitbutton_image = Image.open(r'C:\Users\bossg\OneDrive\Desktop\My Programs\python_programs\BANK IT\Images\submitbutton.png')
